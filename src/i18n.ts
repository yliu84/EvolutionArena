...
const STRINGS = {
  ...
  'mutation.fang-thin-hide.name': { en: 'Thin Hide', zh: '薄皮' },
  'mutation.fang-thin-hide.rule': { en: "All your damage rises by 35%.", zh: '全部伤害提高 35%。' },
  'mutation.fang-thin-hide.cost': { en: "Maximum health falls by 40.", zh: '最大生命降低 40。' },
  'mutation.shell-quake.name': { en: 'Quakestep', zh: '震地' },
  'mutation.shell-quake.rule': { en: "The last step of your chain throws every enemy around you back.", zh: '连击收招会震开你周围的所有敌人。' },
  'mutation.shell-quake.cost': { en: "You move 10% slower for the rest of the run.", zh: '本局剩余时间移速降低 10%。' },
  'mutation.shell-symbiosis.name': { en: 'Symbiosis', zh: '共生' },
  ...
  'mutation.neutral-gluttony.name': { en: 'Gluttony', zh: '暴食' },
  'mutation.neutral-gluttony.rule': { en: "Every third kill offers you another mutation.", zh: '每击杀 3 只怪额外提供一次变异选择。' },
