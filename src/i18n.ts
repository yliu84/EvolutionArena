...
const STRINGS = {
  ...
  'enemy.chase': { en: 'Chasing', zh: '追击' },
  'enemy.recover': { en: 'Recovering', zh: '恢复' },
  'enemy.stunned': { en: 'Stunned', zh: '硬直' },
  'enemy.dead': { en: 'Dead', zh: '死亡' },
  ...
  'hud.msg.guardianDown': { en: 'Broken · {name} has fallen · the final hunt opens', zh: '破防 · {name}已倒下 · 终局猎杀通道开启' },
  'hud.msg.kill': { en: 'Killed · {name} · +{biomass} Biomass · +1 {gene}', zh: '击杀 · {name} · +{biomass} 生物质 · +1 {gene}' },
  'hud.msg.blocked': { en: 'Blocked head-on · only {damage} damage · get behind it', zh: '正面格挡 · 仅造成 {damage} 伤害 · 绕到岩盾背后' },
  ...
  'hud.msg.guardianBroken': { en: '{name} is broken · something stirs at the heart of the wood', zh: '{name}已被击破 · 荒林中心出现异动' },
  'hud.msg.nestDone': { en: 'Nest cleared · {biomass} Biomass · evolution options ready', zh: '窝点清理完成 · {biomass} 生物质 · 进化候选已形成' },
  'hud.msg.tookDamage': { en: 'Took {damage} damage', zh: '受到 {damage} 伤害' },
  'hud.msg.killedByGuardian': { en: 'A heavy blow from {name} ended the hunt', zh: '{name}的重击终结了本次狩猎' },
  'hud.msg.bossPhase2': { en: '{name} is enraged · phase two comes faster', zh: '{name}暴走 · 第二阶段攻势加快' },
  ...
  'hud.msg.guardianRises': { en: '{name} erupts · its front is armoured, break it from behind', zh: '{name}破土而出 · 正面甲壳减伤极高，绕后破防' },
  'hud.msg.bossRises': { en: '{name} wakes from the rot · read the ground tells', zh: '{name}从腐根中苏醒 · 观察地面预警' },
  ...
  'hud.moveKeys': { en: 'W/A/S/D / touch', zh: 'W/A/S/D / 触控' },
  'hud.moveLabel': { en: 'Move', zh: '移动' },
  'hud.lockKeys': { en: 'Tab / Lock', zh: 'Tab / 锁定' },
  'hud.lockLabel': { en: 'Target', zh: '选敌' },
  'hud.attackKeys': { en: 'Space / Attack', zh: 'Space / 攻击' },
  'hud.attackLabel': { en: 'one-button chain', zh: '单键连招' },
  'hud.stateLine': { en: 'Skills off · each prey family has its own weakness and Gene', zh: '技能关闭 · 三类猎物拥有不同弱点与基因' },
  'hud.settings': { en: 'Settings · Esc', zh: '体验设置 · Esc' },
  'evo.eyebrow': { en: 'First evolution · shaped by the hunt', zh: '第一次进化 · 猎食塑形' },
  'evo.headline': { en: 'What you ate is what your body is likely to become', zh: '你吃掉了什么，身体就更可能成为什么' },
  ...
  'hud.attackKeysDyn': { en: '{key} / Attack', zh: '{key} / 攻击' },
  ...
  'hud.titleGuardian': { en: 'Gloamwood · {name} · the nest\'s last line', zh: '幽影林地 · {name} · 窝点最后防线' },
  'hud.titleNest': { en: 'Gloamwood · Corrupted Brood Nest{suffix}', zh: '幽影林地 · 腐根孵育巢{suffix}' },
  'boss.hint.rootSlam': { en: 'Root Slam: leave the inner ring · skills off', zh: '根须震击：离开内圈 · 技能关闭' },
  'boss.hint.thornCharge': { en: 'Thorn Charge: step out of the lane · skills off', zh: '荆棘冲锋：横向离开锁向通道 · 技能关闭' },
  'boss.hint.sporeRing': { en: 'Spore Ring: hug the centre or leave the ring · skills off', zh: '孢子环爆：贴近内圈或退到外圈 · 技能关闭' },
  'hud.targetLine': { en: 'Target {phase} · {weakness}', zh: '目标 {phase} · {weakness}' },
  'weak.shell': { en: 'armoured head-on, hit it from behind', zh: '正面高减伤，绕后攻击' },
  'weak.swarm': { en: 'tail sweep hurts it more', zh: '尾扫伤害更高' },
  'weak.fang': { en: 'claw strikes hurt it more', zh: '爪击伤害更高' },
  ...
  'hud.targetFull': { en: 'Target {phase} · {weakness} · skills off', zh: '目标 {phase} · {weakness} · 技能关闭' },
  'hud.noTargetHint': { en: 'Tab cycles targets · each family has its own weakness · skills off', zh: 'Tab 循环锁定 · 三类猎物拥有不同弱点 · 技能关闭' },
