...
const STRINGS = {
  ...
  'settings.masterLabel': { en: 'Master volume: {value}%', zh: '总音量：{value}%' },
  'settings.musicLabel': { en: 'Music: {value}%', zh: '音乐：{value}%' },
  'settings.sfxLabel': { en: 'Combat & UI: {value}%', zh: '战斗与界面：{value}%' },
  'settings.ambienceLabel': { en: 'World ambience: {value}%', zh: '环境音：{value}%' },
